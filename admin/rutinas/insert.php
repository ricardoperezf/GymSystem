<?php
 ...
 if(!empty($_POST))
 {
      ...
      $elCliente = mysqli_real_escape_string($connect, $_POST["elCliente"]);
     ...
     if($_POST["employee_id"] != '')
      ...
      {
           $query = "
           INSERT INTO rutina(Nombre, id_cliente, id_ejerc1, id_ejerc2, id_ejerc3, id_ejerc4) VALUES ('$nombreDeLaRutina', '$elCliente', '$ejercicio1', '$ejercicio2', '$ejercicio3', '$ejercicio4');
           ";
